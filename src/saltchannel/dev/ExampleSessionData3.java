 ...
 */
public class ExampleSessionData3 {
    ...
    public static void main(String[] args) {
        new ExampleSessionData3().go();
    }
    
    public ExampleSessionData3() {
        tunnel = new Tunnel();
        ...
        // Results in time fields with values: 1, 2, 3, ...
    ...
    private void runServer() {
        ...
        session.setTimeKeeper(timeKeeper);
        session.handshake();
