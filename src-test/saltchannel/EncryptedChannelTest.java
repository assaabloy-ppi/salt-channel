...
public class EncryptedChannelTest {
    ...
    public void testSanity() throws ComException, UnsupportedEncodingException {
        ...
        EncryptedChannel e1 = new EncryptedChannel(tunnel.channel1(), key, EncryptedChannel.Role.CLIENT);
        EncryptedChannel e2 = new EncryptedChannel(tunnel.channel2(), key, EncryptedChannel.Role.SERVER);
