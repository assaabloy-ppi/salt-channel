...
import saltchannel.v1.EncryptedChannelV1;
 ...
 */
public class EncryptedChannelV1Test {

    @Test
    public void testSanity() throws ComException, UnsupportedEncodingException {
        byte[] key = key1();
        Tunnel tunnel = new Tunnel();
        EncryptedChannelV1 e1 = new EncryptedChannelV1(tunnel.channel1(), key, EncryptedChannelV1.Role.CLIENT);
        EncryptedChannelV1 e2 = new EncryptedChannelV1(tunnel.channel2(), key, EncryptedChannelV1.Role.SERVER);
    ...
    public void testWithM3SpecData() {
        ...
        e2.write(m3raw);
        byte[] actual = tunnel.channel1().read();
    ...
    public void testWithM4SpecData() {
        ...
        e1.write(m4raw);
        byte[] actual = tunnel.channel2().read();
